...
export const productListAction = (filter='', params='') => async(dispatch) => {
  try {
    ...
    const {data} = await axios.get(`/api/products/?filter=${filter}&pageNumber=${params}`)
...
export const createProductAction = (product) => async(dispatch, getState) =>{
  try {
    ...
    const {data} = await axios.post('/api/products/add/new-product', product, config)
...
export const addReviewAction = (details, id) => async(dispatch, getState) =>{
  try {
    ...
    const {data} = await axios.post(`/api/products/review/${id}`, details, config)
    dispatch({
...
export const highRatedAction = ()  => async(dispatch) => {
  try {
    ...
    const {data} = await axios.get('/api/products/highly-rated/products')
